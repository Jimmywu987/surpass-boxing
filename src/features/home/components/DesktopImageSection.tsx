...
export const DesktopImageSection = () => {
  return (
    <div className="h-[90vh] md:w-3/6 relative hidden md:flex items-center">
      <div className="absolute z-30 hover:z-40 shadow-2xl top-0 -left-20">
      ...
      <div className="absolute z-20 hover:z-40 shadow-2xl top-20">
        <div className="relative md:w-[300px] lg:w-[400px] xl:w-[540px] h-[50vh] md:h-[60vh] ">
          <Image
            src="/place-1.jpg"
            alt="background-image"
      ...
      <div className="absolute z-10 hover:z-40 shadow-2xl top-40 left-20">
        <div className="relative md:w-[300px] lg:w-[400px] xl:w-[540px] h-[50vh] md:h-[60vh]">
          <Image
            src="/place-2.jpg"
            alt="background-image"
